...
- stat:
  ...
  Statistic of climate trends to add c("min", "1Q", "median", "mean",
  "3Q", "max").
...
#> $ trend_mean_temp     <dbl> 0.0140429, 0.0140429, 0.0140429, 0.0140429, 0.0140…
#> $ trend_temp_var      <chr> "Mean Annual Temperature", "Mean Annual Temperatur…
