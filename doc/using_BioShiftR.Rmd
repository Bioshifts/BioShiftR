...
`BioShiftR` includes various helper functions -- to be used individually or together -- that supplement the dataset from the `get_shifts()` function with other relevant data. View the table below to see all functions and the respective information that they add to the shifts dataframe. Each function adds directly to the shifts dataframe by combinations of ID keys. Some require additional arguments to specify data requests. See function help pages for details.
